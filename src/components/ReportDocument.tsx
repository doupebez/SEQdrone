                ...
                <View style={styles.coverContent}>
                    ...
                    <View style={styles.coverFooter}>
                        <View>
                            ...
                            <Text style={styles.coverFooterText}>ABN: 36 693 406 567</Text>
                        </View>
                ...
                <View style={styles.content}>
                    ...
                    <View style={styles.table}>
                        <View style={styles.tableHeader}>
                            ...
                            <Text style={[styles.tableHeaderCell, { width: '38%' }]}>Finding</Text>
                            <Text style={[styles.tableHeaderCell, { width: '16%' }]}>Severity</Text>
                        ...
                        {damages.map((damage, index) => (
                            <View key={damage.id || index} style={styles.tableRow}>
                                ...
                                <Text style={[styles.tableCellBold, { width: '38%' }]}>{damage.title}</Text>
                                <Text style={[styles.tableCell, { width: '16%', color: getSeverityColor(damage.severity) }]}>
                                    {damage.severity}
                                </Text>
                                <Text style={[styles.tableCell, { width: '16%', color: getConditionColor(damage.conditionRating) }]}>
                                    {damage.conditionRating}
                                </Text>
                                <Text style={[styles.tableCell, { width: '24%' }]}>{damage.component || '—'}</Text>
                            </View>
                        ))}
                    </View>
                </View>
